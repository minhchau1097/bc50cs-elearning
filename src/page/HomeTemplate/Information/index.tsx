    ...
    return (
        <section className='infor-user space-y-2'>
            <div className="px-[50px] py-5">
                <div className="row">
                    <div className="col">
                        <nav aria-label="breadcrumb" className=" card-blur mb-4">
                            <ol className="breadcrumb !bg-transparent mb-0   p-3 rounded-[8px]" >
                                <li className="breadcrumb-item font-semibold hover:scale-110 transition-all delay-100"><Link className='hover:text-black ' to={'/'}>Trang chủ</Link></li>
                ...
                <div className="row">
                    ...
                    <div className="col-lg-8">
                        ...
                        {/* <div className='bg-light  p-3 rounded-[8px]'> </div> */}
                        <div className="row">
